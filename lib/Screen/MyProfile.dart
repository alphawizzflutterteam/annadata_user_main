  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        _getDrawerItem(
            getTranslated(context, 'SHIPPING_POLICY')!, 'assets/images/pro_tc.svg'),
        // _getDivider(),
        _getDrawerItem(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () async {
          if (title == getTranslated(context, 'MY_ORDERS_LBL')) {
          ...
          } else if (title == getTranslated(context, 'SHIPPING_POLICY')) {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PrivacyPolicy(
                    title: getTranslated(context, 'SHIPPING_POLICY'),
                  ),
                ));
            ...
            var str =
                "Annadata\n\n${getTranslated(context, 'APPFIND')}\n\nWebsite:\nhttps://annadatasukhibhav.com/\n\nAndroid:\n\n$androidLink\n\n$iosLink ${getTranslated(context, 'IOSLBL')}";
