...
class _HomePageState extends State<HomePage>
  ...
  void getCat() {
    ...
    print("get caterogy in zipcode $parameter");
    apiBaseHelper.postAPICall(getCatApi, parameter).then((getdata) {
      bool error = getdata["error"];
      String? msg = getdata["message"];
      print('_____________${error}_error_');
      if (!error) {
        var data = getdata["data"];
        catList =
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: CircleAvatar(
                                radius: 30,
                                backgroundImage: NetworkImage("${sellerList[index].seller_profile!}"),
                              ),
                            ),
                            SizedBox(width: 10,),
                            Container(
